...
{
    public class badContainerObjectViewModel : ContainerItemViewModel<IReferenceable>
    {
        ...
        public badContainerObjectViewModel(IContext context, IServiceProvider serviceProvider, IItemContainer<IReferenceable> container, IObject item, OrganizerViewModel org) : base(context, serviceProvider, container, item, org)
        {
